 ...
 <main className="pt-16">
  ...
  >
            ...
            <div className="relative px-8 -mt-16 md:mt-10 flex flex-col md:flex-row md:items-end max-w-5xl mx-auto">
              ...
              <h1 className="text-3xl font-bold text-gray-900 whitespace-nowrap">Szymon Hołownia</h1>
              <svg viewBox="0 0 12 13" width="16" height="16"  title="Zweryfikowane konto" className="fill-[#1877F2] justify-center " style={{"--color":"var(--accent)"}}><title>Zweryfikowane konto</title><g fill-rule="evenodd" transform="translate(-98 -917)"><path d="m106.853 922.354-3.5 3.5a.499.499 0 0 1-.706 0l-1.5-1.5a.5.5 0 1 1 .706-.708l1.147 1.147 3.147-3.147a.5.5 0 1 1 .706.708m3.078 2.295-.589-1.149.588-1.15a.633.633 0 0 0-.219-.82l-1.085-.7-.065-1.287a.627.627 0 0 0-.6-.603l-1.29-.066-.703-1.087a.636.636 0 0 0-.82-.217l-1.148.588-1.15-.588a.631.631 0 0 0-.82.22l-.701 1.085-1.289.065a.626.626 0 0 0-.6.6l-.066 1.29-1.088.702a.634.634 0 0 0-.216.82l.588 1.149-.588 1.15a.632.632 0 0 0 .219.819l1.085.701.065 1.286c.014.33.274.59.6.604l1.29.065.703 1.088c.177.27.53.362.82.216l1.148-.588 1.15.589a.629.629 0 0 0 .82-.22l.701-1.085 1.286-.064a.627.627 0 0 0 .604-.601l.065-1.29 1.088-.703a.633.633 0 0 0 .216-.819"></path></g></svg>
                ...
                <p className="text-gray-600 mt-1">1,1 mln obserwujący • 68 obserwowanych</p>
              </div>
              
              {/* Action buttons */}
              <div className="mt-4 md:mt-0 flex space-x-2">
                <button className="flex items-center px-4 py-2 bg-blue-500 rounded-md font-semibold text-white">
                <img className="filter brightness-0 invert" src="https://static.xx.fbcdn.net/rsrc.php/v4/y9/r/4JLxii282ZM.png" alt="" aria-hidden="true" height="16" width="16"/>
        ...
        <div className="px-4 md:px-8 mt-4 max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="md:w-2/3">
              ...
              <div className="bg-white rounded-lg shadow p-4 mb-4">
                <h2 className="text-xl font-bold mb-3">Wyróżnione</h2>
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    <div className="p-3">
                      <div className="flex items-start">
                        <img src="assets/pelzz.jpg" alt="Szymon Hołownia" className="w-10 h-10 rounded-full mr-2" />
                        <div>
                          <div className="flex items-center">
                          ...
                          <p className="text-xs text-gray-500">5 lutego<span className="ml-1">🌐</span></p>
                        </div>
                      </div>
                      
                      <p className="my-2">Właśnie dlatego kandyduję!</p>
                      <p className="text-sm text-blue-600">#Hołownia2025 #Hołownia25 #Hołownia...</p>
                    </div>
                    
                    <div className="bg-blue-900 text-white p-0 relative" style={{ height: "180px" }}>
                      <img 
                        src="assets/Wyrozone_1.jpg" 
                        alt="To ludzie są najważniejsi" 
                    ...
                    <div className="p-3">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">8 grudnia 2024<span className="ml-1">🌐</span></p>
                        </div>
                      </div>
                      
                      <p className="my-2">Te wybory nie są o mnie...</p>
                      <p className="text-sm">Film miał premierę na...</p>
                    </div>
                    
                    <div className="relative">
                      <img src="/api/placeholder/400/200?text=Campaign Event" alt="Campaign event" className="w-full h-40 object-cover" />
              ...
              <div className="bg-white rounded-lg shadow mb-4">
                ...
                <div className="p-4">
                  <div className="flex items-start mb-3">
                    <div className="relative">
                      <img src="assets/pelzz.jpg" alt="Profile" className="w-10 h-10 rounded-full mr-2 border-2 border-blue-500" />
              ...
              <div className="bg-white rounded-lg shadow mb-4">
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-2 gap-1 mb-3">
                    <p className="mb-3 w-[370px]">Chciałbym zwrócić uwagę na proces sądowy w Baku dotyczący byłych liderów separatystów Karabachu, w tym Rubena Vardanyana. Jako poseł Sejmu uważam, że sprawa ta wykracza daleko poza ramy lokalnego konfliktu i dotyka fundamentalnych zasad prawa międzynarodowego. <br />
...
Jestem głęboko przekonany, że separatyzm to destrukcyjna siła, która narusza normy międzynarodowe, stwarza zagrożenie dla stabilności regionalnej i sieje wrogość między narodami. Ci, którzy wybierają tę drogę, niezależnie od swoich motywów, powinni ponosić odpowiedzialność. Mam nadzieję, że proces sądowy w Baku stanie się ważnym sygnałem dla wszystkich, którzy próbują zdestabilizować sytuację w naszym regionie i poza nim.</p>
              ...
              <div className="bg-white rounded-lg shadow mb-4">
                <div className="p-4">
                  ...
                  <p className="mb-3 w-max">Spotkanie otwarte w Zielonej Górze. Ale to była MOC! 🔥💛<br/> 
                  #ludzie</p>
