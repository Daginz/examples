          ...
          <div className="fixed z-40 top-14 left-0 right-0 bg-white shadow-sm py-3 px-4 flex items-center justify-between">
            <div className="flex items-center">
              <div className="flex items-center px-3 py-2 rounded-lg transition-colors hover:bg-gray-100 cursor-pointer">
                <img src="/public/Assets/pelzz.jpg" alt="Szymon Hołownia" className="w-11 h-11 rounded-full mr-3" />
        ...
        {isMobile ? (
          <div className="absolute left-4 bottom-0 transform translate-y-1/2">
            <div className="w-32 h-32 rounded-full border-4 border-blue-500 overflow-hidden bg-white">
              <img src="/public/Assets/pelzz.jpg" alt="Szymon Hołownia" className="w-full h-full object-cover" />
            </div>
          </div>
        ) : (
            ...
            <div className="md:w-1/3">
              ...
              <div className="bg-white rounded-lg shadow p-4 mb-4">
                ...
                <div className="grid grid-cols-3 gap-1">
                  ...
                  <img src="/public/Assets/photo_221.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />

                  </div>
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_222.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_223.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_224.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_225.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_226.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  
                  <div className="aspect-square bg-blue-600 text-white rounded-md overflow-hidden relative">
                  <img src="/public/Assets/photo_227.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_228.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square bg-gray-200 rounded-md overflow-hidden">
                  <img src="/public/Assets/photo_229.jpg" alt="Photo of a person in suit" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="bg-white rounded-lg shadow mb-4 w-full">
      <div className="p-4">
        ...
        <div className="mb-3 overflow-hidden">
          ...
          <img 
            src="/public/Assets/photo_221.jpg" 
    ...
    <div className="bg-white rounded-lg shadow mb-4 w-full">
      <div className="p-4">
        ...
        <div className="mb-3">
          ...
          <img 
            src="/public/Assets/photo_222.jpg" 
            alt="Hołownia 2025 campaign materials" 
            className="rounded-lg w-full h-full object-cover" 
          />
        </div>
        ...
        <div className="mb-3">
          ...
          {isMobile ? (
            ...
            <div className="grid grid-cols-2 gap-1">
              <img 
                src=" /public/Assets/photo_post1.jpg" 
                alt="People at event" 
                className="rounded-tl-lg w-full h-full object-cover" 
              />
              <img 
                src=" /public/Assets/photo_post2.jpg" 
                alt="People at event" 
                className="rounded-tr-lg w-full h-full object-cover" 
              />
              <img 
                src=" /public/Assets/photo_post3.jpg" 
                alt="People at event" 
                className="w-full h-full object-cover" 
              />
              <div className="relative">
                <img 
                  src=" /public/Assets/photo_post4.jpg" 
                  alt="People at event" 
                  className="w-full h-full object-cover" 
                />
            ...
            <div className="grid grid-cols-2 gap-1">
              ...
              <div className="grid grid-cols-2 gap-1">
                ...
                <div className="relative">
                  <img 
                    src=" /public/Assets/photo_post5.jpg" 
                    alt="People at event" 
                    className="w-full h-full object-cover" 
                  />
                  <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white text-2xl font-bold">
            ...
            <div className="flex flex-col space-y-2">
              ...
              {[1, 2, 3, 4, 5].map((num) => (
                <div key={num} className="flex items-center p-2 rounded-md hover:bg-gray-100 cursor-pointer">
                  <div className="relative">
                    <img src="/public/Assets/pelzz.jpg" alt={`Contact ${num}`} className="w-10 h-10 rounded-full" />
