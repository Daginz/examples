...
const Szymonholowniaoficjalny = () => {
 ...
 <main className="pt-14">
            ...
            <div className="flex justify-between items-start w-full">
              <div>
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-500 text-sm">prowadził transmisję na żywo.</span>
                </div>
      ...
      <div className="px-4 pb-3">
        <div className="mb-2">
          <p>
            Zapraszam do obejrzenia konferencji prasowej w Fabryce Broni Łucznik
          </p>
        </div>
      </div>
      ...
      <div className="relative">
        <video 
          src="/Assets/thelasVideo.mp4" 
          poster="/Assets/thelasVideo.mp4"
        ...
        {/* Indicator that video is muted on autoplay */}
        <div className="absolute bottom-14 left-4 bg-black bg-opacity-60 text-white text-xs px-2 py-1 rounded-md pointer-events-none">
          Automatyczne odtwarzanie z wyciszonym dźwiękiem
        </div>
      </div>
      
      {/* Caption for video */}
      <div className="bg-gray-100 px-4 py-2 text-sm flex items-center">
        <div className="mr-auto">Konferencja prasowa w Fabryce Broni Łucznik</div>
      </div>
      ...
      <div className="px-4 pb-3">
        <div className="mb-2">
          <p className="mb-2">
            To jest ten czas, żebyśmy obudzili europejski przemysł obronny, żebyśmy obudzili świadomość, że czasy nie są już powojenne. Są przedwojenne - mówiłem dziś w Sejmie podczas Konferencji Międzyparlamentarnej ds. Wspólnej Polityki Zagranicznej i Bezpieczeństwa oraz Wspólnej Polityki Bezpieczeństwa i Obrony.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-1 mb-1">
        ...
        <div className="col-span-2">
          <img 
            src="/Assets/thelast1of3.jpg" 
            alt="Szymon Hołownia przemawia w Sejmie" 
            className="w-full h-auto"
          />
        </div>
        ...
        <div className="relative">
          <img 
            src="/Assets/thelast2of3.jpg" 
            alt="Szymon Hołownia zbliżenie" 
            className="w-full h-full object-cover"
          />
        </div>
        ...
        <div className="relative">
          <img 
            src="/Assets/thelast3of3.jpg" 
            alt="Sala plenarna Sejmu" 
            className="w-full h-full object-cover"
          />
        </div>
      </div>
    ...
    <div className="bg-white rounded-lg shadow mb-4 w-full">
      ...
      <div className="px-4 pb-1">
        <div className="mb-2">
          ...
          <p className="text-blue-600">
            <span className="mr-1">#edukacja</span>
            <span className="mr-1">#zmiana</span>
            <span className="mr-1">#przyszłość</span>
            <span className="mr-1">#ludzie</span>
            <span className="mr-1">#prezydent</span><br/>
            <span className="mr-1">#bezpieczeństwo</span>
            <span className="mr-1">#dzieci</span>
            <span className="mr-1">#zdrowie</span>
            <span>#Hołownia2025</span>
          </p>
        </div>
      </div>
      ...
      <div>
        <img 
          src="/Assets/theSec.jpg" 
          alt="Szymon Hołownia przemawia w Gorzowie Wielkopolskim" 
          className="w-full h-auto"
        />
      </div>
    ...
    <div className="bg-white rounded-lg shadow mb-4 w-full">
      ...
      <div className="px-4 pb-3">
        <div className="mb-2">
          <p className="mb-3 ">
            Ś.P. Izabela ze Świeżawskich Piątkowska (1931-2025).
          </p>
          
          <p className="mb-3">
            Była mądra, dzielna, inteligentna, dowcipna i piękna. Przede wszystkim była dobra. Kochała ludzi, zwierzęta (zwłaszcza psy), poezję (którą pisała i tłumaczyła), rozmowę, krainę dzieciństwa nad Bugiem i tyle innych rzeczy.
          </p>
          
          <p className="mb-3">
            Była z naszym ruchem i ze mną od początku. Najwierniejsza, nigdy nie wątpiąca w sens tej zmiany. Kiedy do niej chodziłem żartowała, że się zapisze w annałach Ekipy Szymona jako najstarsza wolontariuszka i nasza „dyżurna staruszka".
          </p>
          
          <p className="mb-3">
            Brakowało jej w ostatnich latach psa, ale nie chciała, żeby kiedyś został sam. My, którzy ją znaliśmy i kochaliśmy dziś czujemy się sami, ale wiemy, że to było pełne i spełnione życie.
          </p>
      ...
      <div className="mb-1">
        <img 
          src="/Assets/theElizabeth.jpg" 
          alt="Szymon Hołownia w rozmowie z Izabelą Piątkowską" 
          className="w-full h-auto"
        />
      </div>
    ...
    <div className="bg-white rounded-lg shadow mb-4 w-full">
      ...
      <div className="px-4 pb-2">
        <div className="mb-2">
          <p className="mb-2">
            Moja Ula <span role="img" aria-label="czerwone serce">❤️</span>
            <span className="text-blue-600"> #żona #małżeństwo #miłość #przyszłość #Hołownia #SzymonHołownia #Hołownia2025 #prezydent</span>
          </p>
        </div>
      </div>
      ...
      <div className="relative bg-black">
        <video 
          src="/Assets/videoWife.mp4" 
          poster="/Assets/videoWife.mp4"
        ...
        <div className="absolute bottom-14 w-full text-center">
          <div className="inline-block bg-black bg-opacity-40 text-blue-300 text-xl px-4 py-1 rounded-md font-bold" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}>
            Chciałam zapytać o Ulę
          </div>
        </div>
      ...
      <div className="flex border-t">
        ...
        <button className="flex-1 py-2 text-gray-500 font-medium text-sm flex items-center justify-center hover:bg-gray-100 rounded">
          ...
          Skomentuj
            ...
            <div className="bg-white rounded-lg shadow mb-4 w-full">
      <div className="p-4">
        {/* Header with user info - Szymon Hołownia */}
            ...
            <div className="flex justify-between items-start w-full">
              <div>
                <div className="flex items-center">
                  ...
                  <span className="text-gray-500 ml-1">jest w miejscowości</span>
                </div>
                <div className="font-semibold">Kutno, województwo łódzkie.</div>
                <div className="flex items-center text-xs text-gray-500">
                  <span>21 godz.</span>
                  <span className="mx-1">·</span>
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="mb-3">
          <p className="mb-2">
            Kutno. Na świeżym powietrzu. Blisko ludzi, z ludźmi i o ludzkich sprawach. Najlepiej <span role="img" aria-label="yellow heart">💛</span>
          </p>
          <p className="mb-2 text-blue-600">
            <a href="#" className="hover:underline">#ludzie</a> <a href="#" className="hover:underline">#Hołownia2025</a>
          </p>
        </div>
        ...
        <div className="mb-3 rounded-lg overflow-hidden">
          <img 
            src="/Assets/groupofPeople.jpg" 
            alt="Szymon Hołownia meeting with crowd in Kutno" 
        ...
        <div className="flex justify-between text-xs text-gray-500 border-b py-2 mb-2">
          ...
          <div>
            <span>471 komentarzy · 71 udostępnień</span>
          </div>
        </div>
      ...
      <div className="p-4">
          ...
          <div className="flex-grow">
            <div className="flex justify-between items-start w-full">
              <div>
                ...
                <div className="font-semibold">Łódź, województwo łódzkie.</div>
                <div className="flex items-center text-xs text-gray-500">
                  <span>1 dzień</span>
                  <span className="mx-1">·</span>
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 16 16">
        ...
        {/* Post content - text */}
          <div className="mb-3">
            <p className="mb-2">
              Wizytę w Łodzi zaczynam od rozmowy z cudowną i pełną ciepła Panią Elą, przedsiębiorczynią, która od 7 lat prowadzi kwiaciarnię na Bałutach.
            </p>
            <p className="mb-2">
              Rozmawialiśmy długo. O tym jak to jest dziś prowadzić biznes w Polsce. O wyzwaniach i problemach. I o tym, co trzeba zrobić.
            </p>
            <p className="mb-2">
              Na końcu - stały element. Zakupy dla moich dziewczynek 💐...
            </p>
            <p className="text-blue-600">
            <a href="#" className="hover:underline">#ludzie</a>
        ...
        <div className="mb-3">
          <div className="grid grid-cols-1 gap-1">
            <div className="overflow-hidden rounded-lg">
              <img 
                src="/Assets/new_newpost1of2.jpg" 
                alt="Szymon Hołownia talking with flower shop owner" 
                className="w-full object-cover" 
              />
            </div>
            <div className="overflow-hidden rounded-lg">
              <img 
                src="/Assets/new_newpost2of2.jpg" 
                alt="Szymon Hołownia in flower shop with owners" 
                className="w-full object-cover" 
              />
            </div>
          </div>
        ...
        <div className="flex justify-between text-xs text-gray-500 border-b py-2 mb-2">
          ...
          <div>
            <span>232 komentarzy · 54 udostępnienia</span>
          </div>
        </div>
